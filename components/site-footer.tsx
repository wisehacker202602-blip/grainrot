    ...
    <footer className="site-footer" lang={config.htmlLang}>
      <div className="site-footer__inner">
        ...
        <div className="site-footer__links">
          <div><strong>{label("Explore")}</strong><Link href="/platforms/">{label("Platforms")}</Link><Link href={locale === "en" ? "/guides/" : config.href}>{label("Guides")}</Link><Link href="/wiki/">{label("Guide directory")}</Link></div>
