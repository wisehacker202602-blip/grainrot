...
export const localeConfig: Record<ArticleLocale, LocaleConfig> = {
  en: {
    ...
    hubTitle: "GRAIN ROT Wiki, Guides & Platform Status", hubDescription: "An independent GRAIN ROT wiki covering platforms, guides, fixes, settings, enemies, and community resources.", hubHeading: "GRAIN ROT Wiki", hubKicker: "Evidence-led field guide", hubIntro: "Verified answers for GRAIN ROT players.",
